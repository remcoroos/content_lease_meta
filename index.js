  ...
  try {
    ...
    async function processItem(item) {
      ...
      const transformation = [
        ...
        { width: 1080, height: 950, crop: 'pad', background: 'rgb:1c0a30', gravity: 'north' },
        ...
        { overlay: { font_family: 'Arial', font_size: 50, font_weight: 'bold', text: mainOverlayTitle },
          gravity: 'north_west', x: 60, y: 810, color: '#ffffff', width: 960, crop: 'fit' },
        ...(subOverlayTitle ? [{ overlay: { font_family: 'Arial', font_size: 34, text: subOverlayTitle },
          gravity: 'north_west', x: 60, y: 875, color: '#9baabf', width: 960, crop: 'fit' }] : []),
        { overlay: { font_family: 'Arial', font_size: 38, font_weight: '600', text: description },
          gravity: 'south_west', x: 60, y: 50, color: '#9baabf', width: 500, crop: 'fit' },
        { overlay: { font_family: 'Arial', font_size: 36, text: formattedPrice },
          gravity: 'south_east', x: 60, y: 130, color: '#ffffff' },
